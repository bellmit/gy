  ...
  <div class="approval">
      <div class="gy-form first_div">
        ...
        <div class="gy-form-group">
            <span class="l isRequired">注册日期:</span>
            <el-date-picker
                class="form-date"
        ...
        <div class="gy-form-group ">
            <span class="l isRequired">注册资本(万元):</span>
            <div   v-if="groupId===0">
                  <input class="gy-input row_half" type="number" v-model.number="form.registeredCapital" placeholder="请填写">
                  <el-select  class="gy-input row_half" v-model="form.registeredCapitalCurrencyId"  placeholder="请填写">
                        <el-option
            ...
            <span v-else>{{form.registeredCapital|dataFormat}}</span>
        </div>
         <div class="gy-form-group">
        ...
        <div class="gy-form-group">
            ...
            <div   v-if="groupId===0">
                 ...
                 <el-select  class="gy-input row_half" v-model="form.realCapitalCurrencyId"  placeholder="请填写">
                        <el-option
                        v-for="item in currencyList"
                        :key="item.id"
                        :label="item.displayName"
            ...
            <span v-else>{{form.realCapital|dataFormat}}</span>
        </div>
        <div class="gy-form-group">
     ...
     <div class="gy-form myDashed" v-for="(item, index) in form.ratingApprovalShareholderModel" :key="index+100">
            ...
            <div class="gy-form-group ">
                ...
                <el-select   v-if="groupId===0" class="gy-input" v-model="item.shareholderTypeId"  placeholder="请填写">
                        <el-option
                ...
                <span v-else>{{item.shareholderTypeId|dataFormat}}</span>
            </div>
             <div class="gy-form-group">
                <span class="l">认缴金额(万元):</span>
                <div   v-if="groupId===0">
                    <input class="gy-input row_half" type="number" v-model.number="item.subscribedAmount" placeholder="请填写">
                    <el-select  class="gy-input row_half" v-model="item.subscribedAmountCurrencyId"  placeholder="请填写">
                            <el-option
                            v-for="item in currencyList"
                            :key="item.id"
                            :label="item.displayName"
                ...
                <span v-else>{{item.subscribedAmount|dataFormat}}</span>
            </div>
             <div class="gy-form-group">
             ...
             <div class="gy-form-group">
                <span class="l">实缴金额(万元):</span>
                 <div   v-if="groupId===0">
                    ...
                    <el-select  class="gy-input row_half" v-model="item.realAmountCurrencyId"  placeholder="请填写">
                            <el-option
                            v-for="item in currencyList"
                            :key="item.id"
                            :label="item.displayName"
                ...
                <span v-else>{{item.realAmount|dataFormat}}</span>
            </div>
             <div class="gy-form-group">
             ...
             <div class="gy-form-group">
                <span class="l">缴纳类型:</span>
                 <el-select   v-if="groupId===0" class="gy-input" v-model="item.payTypeId"  placeholder="请填写">
                        <el-option
                ...
                <span v-else>{{item.payTypeId|dataFormat}}</span>
            </div>
     ...
     <div class="gy-form myDashed" v-for="(item, index) in form.ratingApprovalCompanyXrefModel" :key="index+1">
         ...
         <div class="gy-form-group">
            <span class="l">注册资本(万元):</span>
             <div   v-if="groupId===0">
                ...
                <el-select  class="gy-input row_half" v-model="item.registeredCapitalCurrencyId"  placeholder="请填写">
                        <el-option
                        v-for="item in currencyList"
                        :key="item.id"
                        :label="item.displayName"
            ...
            <span v-else>{{item.registeredCapital|dataFormat}}</span>
        </div>
         <div class="gy-form-group">
        ...
        <div class="gy-form-group">
            ...
            <!-- <input v-if="groupId===0" class="gy-input" v-model="item.remark" cols="30" rows="10" placeholder="请填写"> -->
            <textarea  v-if="groupId===0" class="gy-textarea" placeholder="详细地址"  v-model="item.remark" ></textarea>
            <span v-else>{{item.remark|dataFormat}}</span>
        </div>
        </div>
     ...
     <div class="gy-form" >
      ...
      <div v-if="groupId === 0" class="gy-form-group single-row btn-wrap">
            ...
            <!-- <button class="gy-button-normal m-r" @click="submit(2)">提交</button> -->
     </div>
  </div>
</template>
<script>
