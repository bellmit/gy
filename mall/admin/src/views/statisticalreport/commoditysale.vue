<template>
    <div class="commodity-main">
        ...
        <div class="seniorSearch-row">
            ...
            <el-row>
                <el-col :span="1" class="font-black">&nbsp;产品:&nbsp;</el-col>
                <el-col :span="6">
                ...
                <el-col :span="1" class="font-black">&nbsp;</el-col>
        ...
        <div class="list">
            <table class="gy-table">
                ...
                <tr v-for="(item, index) in data.list" :key="index">
                    ...
                    <td>{{item.skuName}}</td>
                    <td>{{item.tradeNum}}</td>
                    <td>{{item.orderTrade}}</td>
                    <td>{{item.settlementTrade}}</td>
                </tr>
                </tbody>
            </table>
...
export default {
    ...
    methods: {
        getList () { // 获取信息
            let _this = this;
            _this.$http.post(_this.$api.statisticalReport.commoditySaleList, _this.parameter).then(function (res) {
