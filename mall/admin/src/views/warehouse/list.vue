  ...
  <div class="page">
    <div class="m-panel">
      ...
      <div class="btns-wrapper">
            ...
            <button class="gy-button-extra" @click="editAll" v-if="isAuth('member:warehouseCompany:edit')">编辑</button>
            <button class="gy-button-normal" @click="verifyAll" v-if="isAuth('member:warehouseCompany:approval')">审核</button>
            <button class="gy-button-normal" @click="deleteAll" v-if="isAuth('member:warehouseCompany:disable')">停用</button>
            <button class="gy-button-normal" @click="startAll" v-if="isAuth('member:warehouseCompany:enable')">启用</button>
      </div>
