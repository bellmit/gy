          ...
          <el-col :span="12">
            ...
            <el-row>
              <el-col :span="24" style="position: relative">
                ...
                <i class="iconfont icon-mySearch" style="position: absolute;right: 0;top: 0;" @click="onelist1click"></i>
              </el-col>
            ...
            <el-form-item label="需求量" prop="skuQuantity">
              <el-row>
                <el-col :span="23">
                   <el-row>
                     <el-col :span="12">
                       <input type="text" style="margin-top:-2px;" placeholder="请输入需求量" v-model="info.skuQuantity"/>
                     </el-col>
                     <el-col :span="12">
    ...
    data () {
        ...
        return {
            ...
            ruleForm: {
                ...
                skuQuantity: [{ required: true, message: '请输入需求量', trigger: 'blur' }], // 需求量
                // skuMinQuantity: [{ required: true, message: '请输入最小起订量', trigger: 'blur' }], // 起订量
    ...
    methods: {
        ...
        submitForm () {
            ...
            if (this.offerId) {
                ...
                this.$http.post(this.$api.offers.demand, this.info).then((res) => {
                    if (res.data.code === 0) {
