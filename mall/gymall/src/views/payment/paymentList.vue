  ...
  <div class="payment-list">
    ...
    <div class="payment-list-tabs ">
      <el-tabs v-model="activeName" @tab-click="handleClick" class="my-tabs">
        ...
        <el-tab-pane label="付款申请" name="second"></el-tab-pane>
        <el-tab-pane label="财务付款" name="third"></el-tab-pane>
        <el-tab-pane label="收款确认" name="fourth"></el-tab-pane>
        <el-tab-pane label="已失效" name="fifth"></el-tab-pane>
      </el-tabs>
      <div>
        <div class="payment-list-content">
          <div class="payment-list-content-query clearfix">
            ...
            <div class="payment-list-content-query-iptbox fr"><input class="payment-list-content-query-iptbox-ipt" v-model="queryCriteria" type="text"
                     placeholder="请输入付款单号"/><i class="iconfont icon-search" @click="getPaymentList(1)"></i></div>
          </div>
          <div class="payment-list-content-item-box" v-show="isSeniorSearch">
            ...
            <div class="payment-list-content-item clearfix payment-list-content-item-right">
          ...
          <div class="payment-list-content-item-box" v-show="isSeniorSearch">
              <div class="payment-list-content-item clearfix">
                  ...
                  <el-select class="payment-list-content-item-input fl" v-model="tradeMode" placeholder="请选择">
                      <el-option
            ...
            <div class="payment-list-content-item clearfix payment-list-content-item-right">
              <label class="payment-list-content-item-tit fl">收款企业</label>
              <el-select class="payment-list-content-item-input fl" v-model="receiveCompanyId" placeholder="请选择">
                <el-option
          ...
          <div class="payment-list-result" v-show="resultList.length>0">
            <div class="payment-list-result-th">
              <span class="payment-list-result-th-item result-item-width20">付款单号</span>
              <span class="payment-list-result-th-item result-item-width10">收款企业</span>
              <span class="payment-list-result-th-item result-item-width10">付款单状态</span>
              <span class="payment-list-result-th-item result-item-width20">订单编号</span>
              <span class="payment-list-result-th-item result-item-width10">付款金额</span>
              <span class="payment-list-result-th-item result-item-width10">支付方式</span>
              <span class="payment-list-result-th-item result-item-width10">付款类型</span>
              <span class="payment-list-result-th-item result-item-width10">付款日期</span>
            </div>
            <a href="javascript:void(0)" @click="gotoDetail(item.id,item.payStatus)" class="payment-list-result-tb-item" v-for="(item,index) in resultList"
              ...
              <span class="payment-list-result-tb-item-colum result-item-width10">{{item.receiveCompanyName}}</span>
              <span class="payment-list-result-tb-item-colum result-item-width10">{{item.payStatus|paymentStatus}}</span>
              <span class="payment-list-result-tb-item-colum result-item-width20">{{item.orderNumber}}</span>
              <span class="payment-list-result-tb-item-colum result-item-width10">{{item.payTotalStr}}</span>
            ...
            <form method="POST" action="/trade/pay/v1/billPayment/exportExcel" id="hiddenForm" ref="hiddenForm">
...
export default {
    ...
    data () {
        return {
            ...
            payStatusOptionsForTab: this.$constant.paymentStatus.filter(item => item.label !== '交付中'),
            payStatus: 0,
