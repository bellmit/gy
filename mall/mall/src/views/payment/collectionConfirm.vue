  ...
  <div class="userCenter-main createPayment">
    ...
    <div class="createPayment-status createPayment-common clearfix">
      <div class="createPayment-status-left">
        ...
        <!--</div>-->
          <div class="createPayment-status-left-billStatus">
              <step step="1" :isActive='this.collectionStatus >= 10' showLine='' :isDone="this.collectionStatus >= 10">
                  <div class="createPayment-status-left-billStatus-unconfirm">
                      <span>等待确认</span>
                  </div>
              </step>
              <step step="2" :isActive="this.collectionStatus >= 20" isRight="true" showLine='true' :isDone="this.collectionStatus >= 50">
                  <div class="createPayment-status-left-billStatus-confirmed">
                      <span>已确认</span>
                  </div>
              </step>
      ...
      <div class="createPayment-status-right fr">
        <button @click="auditingCollection(1)" class="createPayment-status-right-submit btn-active">确认</button>
        <button @click="auditingCollection(2)" class="createPayment-status-right-submit btn">驳回</button>
      </div>
    </div>
      <div class="createPayment-detail createPayment-common">
          ...
          <div class="content-info">
              <el-row class="my-row">
                  ...
                  <el-col :span="9"><span style="color:red;font-weight: bold;">{{amount}}</span> 元</el-col>
