        ...
        <div class="product-general commom-part">
            ...
            <div class="product-general-price-time product-general-item-box clearfix">
                ...
                <div class="fl product-general-item">
                    ...
                    <span v-if="productInfo.deliveryDateFlag ===3">{{productInfo.deliveryDateText}}</span>
                    <span v-else-if="productInfo.deliveryDateFlag === 2" >{{productInfo.deliveryBeginDate|date}}以前</span>
                    <span v-else>{{productInfo.deliveryBeginDate|date}}到{{productInfo.deliveryEndDate|date}}</span>
                ...
                <div class="product-general-right button-box">
                    ...
                    <button class="gy-button-normal gy-button-normal-inquiry" @click="goNext(0)">我要询价<i class="iconfont icon-im"></i></button><button class="gy-button-normal" @click="goNext(1, productInfo.skuCode, productInfo.skuName)" v-if="companyTypeId !== 2">找物流</button>
                </div>
            </div>
            <!--<div class="product-general-price-time product-general-item-box clearfix" style="margin-top: 20px;">-->
                <!--<div class="fl product-general-item">-->
