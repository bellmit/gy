        ...
        <div class="home">
            ...
            <div class="wrap-main">
                        ...
                        <tr v-for="(item, index) in dealInfo.prodList" :key="index">
                            ...
                            <td class="highlight">
                                <template v-if="item.skuPrice">
                                    {{item.currencyMark}}{{item.skuPriceStr}}元
                                </template>
                                <template v-else>
                                    面议
                                </template>
                ...
                <div class="partner">
                    ...
                    <span class="bg-img"><a href="http://www.cpcia-award.org.cn" target="_blank"><img src="http://pic.chinayie.com/adv/20160905/adv57cd8516bc708.png" alt=""></a></span>
