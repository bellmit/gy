        ...
        <form action="javascript:;">
            <div class="gy-form">
                ...
                <div class="gy-form-group form-group-address">
                    ...
                    <el-select v-model="companyInfo.cityId" placeholder="请选择市" @change="cityChange"
                               class="select-province" :disabled="companyInfo.authStatus !== 3">
                        <el-option
                    ...
                    <el-select v-model="companyInfo.districtId" placeholder="请选择区" class="select-province"
                               :disabled="companyInfo.authStatus !== 3" style="margin-right: 0;">
                        <el-option
                    ...
                    <input type="text" v-model="companyInfo.address" :disabled="companyInfo.authStatus !== 3"
                           class="address">
                </div>
                ...
                <div class="gy-form-group single-row">
                    ...
                    <div class="license-upload-box">
                        <div class="item">
                            ...
                            <span class="mask"
                                  v-show="Number(licenseOption) === 1 || companyInfo.authStatus !== 3"></span>
                        </div>
                        <div class="item">
                            ...
                            <span class="mask"
                                  v-show="Number(licenseOption) === 0 || companyInfo.authStatus !== 3"></span>
                        </div>
                    </div>
                </div>
                <div class="gy-form-group single-row">
