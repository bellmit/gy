<template>
    <div class="money-account rollOut">
        ...
        <div class="money-account-common common-padding">
            <div class="new-title-moneyAccount">
            ...
            <div class="clearfix money-accounts">
                <div class="money-accounts-left fl clearfix">
                    <img class="fl" :src="bankInfo.bigIcon"/>
                    <div class="fr money-accounts-left-items">
                        ...
                        <div class="money-accounts-left-amount">
                            <div class="money-accounts-left-amount-item">
                                ...
                                <div class="money-accounts-left-amount-item-num">{{bankInfo.actualBalance|numToCash(2)}}</div>
                            </div>
                            <div class="money-accounts-left-amount-item">
                                <div class="money-accounts-left-amount-item-tit">冻结余额（元）</div>
                                <div class="money-accounts-left-amount-item-num">{{bankInfo.blockedBalance |numToCash(2)}}</div>
                            </div>
                            <div class="money-accounts-left-amount-item">
                                <div class="money-accounts-left-amount-item-tit">可用余额（元）</div>
                                <div class="money-accounts-left-amount-item-num">{{bankInfo.accountBalance |numToCash(2)}}</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="money-account-common common-padding">
            ...
            <div class="gy-form">
                <div class="gy-form-group">
                    ...
                    <div style="padding-left: 10px">{{bankInfo.usrCompanyName}}</div>
                </div>
                <div class="gy-form-group panel-parent">
                    <span class="l"><em class="required">*</em>账号</span>
                    <input placeholder="请输入" class="gy-input" v-model="form.recvAccNo">
                    <div class="grop-r panel" @click="panelDialog">收款账号</div>
                </div>
                <div class="gy-form-group ">
                ...
                <div class="gy-form-group my-group">
                    ...
                    <input placeholder="请输入" class="gy-input" type="number" v-model="form.tranAmt">
                ...
                <div class="gy-form-group">
                    ...
                    <div style="padding-left: 10px">{{userInfo.username}}</div>
                </div>
                <div class="gy-form-group">
                    <span class="l">联系电话</span>
                    <div style="padding-left: 10px">{{userInfo.phone}}</div>
                </div>
                <div class="my-btn-zc">
        ...
        <!-- 收款账号名册 -->
        <el-dialog title="常用收款账号名册" class="new-rollOut-dialog" :visible.sync="isPanel">
            <div class="tabs">
                <table>
                    <thead>
                    <tr>
