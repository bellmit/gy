<template>
    <div class="clearfix">
        ...
        <div class="pl-20">
            <div class="gy-form-group" v-if="!supply.scsAppModel.thirdPartyId">
                <span class="l">供应商</span>
                {{form.supplierCompanyName || '--'}}
            </div>
            <div class="gy-form-group" v-if="!supply.scsAppModel.thirdPartyId">
            ...
            <div class="gy-form-group">
                <span class="l">采购保证金</span>
                <span v-if="form.buyContractAmount">{{form.buyContractAmount}}%</span>
                <span v-else>--</span>
            </div>
            <div class="gy-form-group">
            ...
            <div class="gy-form-group">
                <span class="l">销售订单分批</span>
                {{form.saleIsBatchDelivery === 1 ? '是' : '否'}}
            </div>
            <div class="gy-form-group">
                <span class="l">采购订单分批</span>
                {{form.buyIsBatchDelivery === 1 ? '是' : '否'}}
            </div>
        </div>
