<template>
    <div class="clearfix">
        <div class="title">
            ...
            <a v-if="(supply.appProviderModel.status && supply.appProviderModel.status >= 210
                && supply.appProviderModel.status !== 220) || supply.appProviderModel.initiatorUserId"
                       href="javascript:void(0);" class="gy-link" @click.stop="serviceProviderHistory">服务方案审批详情 </a>
        </div>
        ...
        <div class="title" @click="moduleItems.explain = !moduleItems.explain"><i class="iconfont icon-gdxq"></i>更多详情<i class="el-icon-arrow-down" :class="{'el-rotate' : moduleItems.explain}"></i></div>
            ...
            <div v-show="moduleItems.explain" class="clearfix">
                ...
                <div class="pl-20">
                    <div class="gy-form-group single-row">
                        ...
                        <div class="pd10" v-if="form.riskDescription" v-html="form.riskDescription.replace(/\n/g, '<br>')"></div>
                        <span v-else>--</span>
                    </div>
                </div>
                ...
                <div class="pl-20">
                    <div class="gy-form-group single-row">
                        ...
                        <div class="pd10" v-if="form.cooperationDescription" v-html="form.cooperationDescription.replace(/\n/g, '<br>')"></div>
                        <span v-else>--</span>
                    </div>
                </div>
                ...
                <div class="pl-20">
                    <div class="gy-form-group single-row">
                        ...
                        <div class="pd10" v-if="form.otherDescription" v-html="form.otherDescription.replace(/\n/g, '<br>')"></div>
                        <span v-else>--</span>
                    </div>
                </div>
                ...
                <div class="pl-20">
                    <div class="gy-form-group single-row">
                        <span class="l">补充说明</span>
                        <div class="pd10" v-if="form.replenishDescription" v-html="form.replenishDescription.replace(/\n/g, '<br>')"></div>
                        <span v-else>--</span>
                    </div>
