<template>
    <div class="transport-wrap">
        ...
        <div class="gy-form">
            ...
            <div class="gy-form-group" v-if="!isOrderStarted && isOrderStarting">
                <span class="l">承运商联系人</span>
                <span>
                    <input type="text" class="gy-input" v-model="startOrderData.carrierContactName">
                </span>
            </div>
            <div class="gy-form-group">
            ...
            <div class="gy-form-group" v-if="!isOrderStarted && isOrderStarting">
                <span class="l">承运商手机号</span>
                <span>
                    <input type="text" class="gy-input" v-model="startOrderData.carrierContactMobile">
                </span>
            </div>
            <div class="gy-form-group">
    ...
    methods: {
        init () {
            ...
            if (localStorage.getItem('userInfo')) {
                ...
                this.startOrderData.carrierId = ui.companyId;
                this.startOrderData.carrierContactName = ui.username;
                this.startOrderData.carrierContactMobile = ui.phone;
            }
            this.getEnquiryInfo();
        ...
        orderStart () {
            ...
            this.startOrderData = {
                ...
                carrierContactName: ui.username,
                carrierContactMobile: ui.phone,
