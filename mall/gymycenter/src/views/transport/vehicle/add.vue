<template>
    <div class="transport-wrap">
        <h2>{{id ? '车辆管理' : '车辆管理'}}</h2>
        <div class="clearfix">
            <h3><i class="iconfont icon-icon_shenqing"></i>基础信息</h3>
            <div class="gy-from-box">
                ...
                <div class="gy-frombox cl" v-if="vehicleData.infLogisticsDictionaryIdVehicleType ===null || vehicleData.infLogisticsDictionaryIdVehicleType ===8">
                    <div class="gy-form-group" style="height:46px;">
                        ...
                        <input type="text" style="width:90%;" class="gy-input" v-model="vehicleData.tubeVolume" placeholder="请输入">&nbsp;&nbsp;m³
                    </div>
                    <div class="gy-form-group">
                ...
                <div class="gy-frombox cl" v-if="vehicleData.infLogisticsDictionaryIdVehicleType ===9 || vehicleData.infLogisticsDictionaryIdVehicleType ===10 || vehicleData.infLogisticsDictionaryIdVehicleType ===11">
                    <div class="gy-form-group" style="height:46px;">
                        ...
                        <input type="text" style="width:24.2%;" class="gy-input" v-model="vehicleData.vehicleLength" placeholder="请输入">&nbsp;长&nbsp;
                        <input type="text" style="width:24.2%;" class="gy-input" v-model="vehicleData.vehicleWidth" placeholder="请输入">&nbsp;宽&nbsp;
                        <input type="text" style="width:24.2%;" class="gy-input" v-model="vehicleData.vehicleHeight" placeholder="请输入">&nbsp;高&nbsp;
                    </div>
                    <div class="gy-form-group">
                        <span class="l"><strong>*</strong>核载重量</span>
                        <input type="text" style="width:92%;" class="gy-input" v-model="vehicleData.loadWeight" placeholder="请输入">&nbsp;吨&nbsp;
                    </div>
                    <div class="gy-form-group">
                        <span class="l">牵引总重量</span>
                        <input type="text" style="width:92%;" class="gy-input" v-model="vehicleData.vehicleTractionTotalWeight" placeholder="请输入">&nbsp;吨&nbsp;
                    </div>
                    <div class="gy-form-group">
                        <span class="l">总载重重量</span>
                        <input type="text" style="width:92%;" class="gy-input" v-model="vehicleData.vehicleLoadTotalWeight" placeholder="请输入">&nbsp;吨&nbsp;
                    </div>
                </div>
                <!--  -->
                ...
                <div class="gy-form-group">
                    <span class="l"><strong>*</strong>保险单</span>
                    <gy-upload
                        :url="imgApi"
                        :limit="1"
                ...
                <div class="gy-form-group">
                    ...
                    <input type="text" style="width:89%;" class="gy-input" v-model="vehicleData.vehicleInsuredAmount">万元
                </div>
                <div class="gy-form-group cl">
                    <span class="l"><strong>*</strong>保险单号</span>
            ...
            <div class="gy-form-button">
                <button class="gy-button-extra mr10" @click="addvehiclesave">{{id ? '提交' : '提交'}}</button>
