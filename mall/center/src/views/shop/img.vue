<template>
    <div class="order lic shop-img">
                ...
                <div class="gy-form my-form">
                    ...
                    <div v-if="advancedSearch">
                        <div class="gy-form-group">
                            <div class="l">图片状态</div>
                            <label><input type="radio" v-model="searchForm.active" name="payway" value="">全部</label>
                            <label><input type="radio" v-model="searchForm.active" name="payway" value="1">有效</label>
                            <label><input type="radio" v-model="searchForm.active" name="payway" value="0">无效</label>
                        </div>
                        <div class="gy-form-group last-group">
                            <div class="l">说明</div>
                            <input class="gy-input" v-model="searchForm.remark">
                            <i @click="remarkSearch" class="iconfont icon-search"></i>
                        </div>
                    </div>
        ...
        <el-dialog title="新增首页广告图" :visible.sync="isADDialog" :close-on-click-modal="false">
            <form action="javascript:;">
                <div class="gy-form imgForm clearfix">
                    ...
                    <div class="gy-form-group">
                        ...
                        <label><input type="radio" v-model="imgADForm.active" name="payway" value="1">有效</label>
                    ...
                    <div class="gy-form-group">
                        ...
                        <input class="gy-input" v-model="imgADForm.remark">
                    </div>
                </div>
            </form>

            <div class="gy-form-button">
                <button class="gy-button-extra" @click="submitAD">保存</button>
                <button class="gy-button-normal" @click="isADDialog = false">取消</button>
            </div>
        </el-dialog>

        <!--productDialog-->
        <el-dialog title="新增产品分类图" :visible.sync="isProductDialog" :close-on-click-modal="false"
            ...
            <form action="javascript:;">
                <div class="gy-form imgForm clearfix">
                    ...
                    <div class="gy-form-group my-group-classify">
                    ...
                    <div class="gy-form-group">
                        <span class="l">状态</span>
                        <label><input type="radio" v-model="imgProductForm.active" name="payway" value="1">有效</label>
                    ...
                    <div class="gy-form-group">
                        <span class="l">说明</span>
                        <input class="gy-input" v-model="imgProductForm.remark">
                    </div>
                </div>
            </form>

            <div class="gy-form-button">
                <button class="gy-button-extra" @click="submitProduct">保存</button>
