<template>
    <div class="order-list my-order-list">
                    ...
                    <el-row :gutter="60">
                        <el-col :span="12">
                            <el-row class="newrel">
                                ...
                                <el-col class="newabl" :span="1"> <i class="iconfont icon-icon_shaixuan"  @click="onelist1click2"></i></el-col>
            ...
            <div class="mytable">
                <table>
                    ...
                    <tr class="update-title">
                        <td colspan="6">单号：{{item.odrOrderSn}} <span
