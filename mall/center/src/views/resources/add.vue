<template>
    <div class="resource-add new_resourseadd">
        <div>
            <div class="top1">
                <span class="title">{{offerId ? '编辑商品资源单': '新增商品资源'}}</span>
            </div>
            <div>
                        ...
                        <el-row :gutter="60">
                            <el-col :span="12" class="display-inlinecol">
                                <el-form-item label="单价(元)" prop="skuPrice">
                                    <el-input v-model.number="info.skuPrice" v-bind:disabled="disabledInput"
                        ...
                        <el-row :gutter="60">
                            <el-col :span="12" class="display-inline">
                                <el-form-item label="可供量" prop="skuQuantity">
                                    <el-input style="width: 214px;" v-model="info.skuQuantity"></el-input>
                            ...
                            <el-col :span="12">
                                <el-form-item label="起订量" prop="skuMinQuantity">
                                    <el-input v-model="info.skuMinQuantity"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                            ...
                            <el-col :span="12">
                                <el-form-item label="交割库">
                                    <div class="product-list">
                                        <input type="text" class="gy-input" v-model="deliveryWarehouseName"
