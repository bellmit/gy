        ...
        <div class="mytable">
            <div class="right my_right">
                <router-link to="/resources/add">
                    <button class="gy-button-extra">发布资源单</button>
                </router-link>
                <button v-if="newIndex!=1&&newIndex!=3" class="gy-button-normal" @click="batchOperation(0)">批量上架
                </button>
                <button v-if="newIndex!=2&&newIndex!=3" class="gy-button-normal" @click="batchOperation(1)">批量下架
                </button>
            </div>
            <table>
                <tr class="title">
                ...
                <tr class="update-date">
                    <td colspan="8">单号：{{sub.odrOfferSn}}<span
                ...
                <tr class="item">
                    ...
                    <td class="tleft" v-if="sub.deliveryDateFlag === 3" style="width:11.5%">{{sub.deliveryDateText}}</td>
                    <td class="tleft" v-else-if="sub.deliveryDateFlag === 2"  style="width:11.5%">{{sub.deliveryBeginDate|date}}以前</td>
                    <td class="tleft" v-else style="width:11.5%">{{sub.deliveryBeginDate|date}}到{{sub.deliveryEndDate|date}}</td>
                    <td style="width:11.5%">
