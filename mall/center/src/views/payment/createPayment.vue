    ...
    <div class="createPayment">
        ...
        <div class="createPayment-detail createPayment-common">
            ...
            <div class="content-info">
                <el-row class="my-row">
                    <el-col :span="4" class="font-weight" v-if="payMethod!=2">本次付款金额</el-col>
                    <el-col :span="4" class="font-weight" v-if="payMethod==2">本次支付保证金</el-col>
                    <el-col :span="9">
                        <!--<el-input-->
                        <!--v-model="amount"-->
                        <!--debounce="50"-->
                        ...
                        <!--@change="hanldeInput"-->
                        <!--placeholder="请输入金额"-->
                        <!--class="createPayment-detail-amount-input"> // readonlyFlg                     @change="hanldeInput"-->
                        <input
                            v-model="amount"
                ...
                <el-row class="my-row">
                    ...
                    <el-col :span="20">{{accountNumber}}&nbsp;</el-col>
                </el-row>
                <el-row class="my-row">
