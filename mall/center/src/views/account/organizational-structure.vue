<template>
    <div class="organization-structure">
            ...
            <div>
                ...
                <div class="gy-form-group">
                    ...
                    <div class="chkHigherAuthorities">
                        <input type="text" placeholder="请选择" v-model="addDepartment.parentName" @click="chkHigherAuthorities = true">
                        <i class="el-icon-arrow-down" @click="chkHigherAuthorities = true" style="position: absolute;right: 0;top: 7px;"></i>
        ...
        <el-dialog width="600px" title="添加人员" :visible.sync="dialogAddPerson">
            <div v-if="dialogAddPerson">
                <div style="max-height: 400px;overflow: auto">
                    <table class="gy-table">
                        <thead>
                        <tr>
                            <th><el-checkbox @change="addPersonChkAll"></el-checkbox><span style="margin-left: 5px">#</span></th>
                            <th>人员姓名</th>
                            <th>手机号</th>
                        </tr>
                        </thead>
                        ...
                        <tr v-for="(item, index) of companyPersonList" :key="index">
                            <td>
                                <el-checkbox v-model="item.isOrganization" :true-label="1" :false-label="0"></el-checkbox>
                ...
                <div style="text-align: right;margin-top: 15px">
                    <span class="gy-button-extra" @click="doAddPerson">确定</span>
