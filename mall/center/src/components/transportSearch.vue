       ...
       <div class="trans_new">
           <el-row :gutter="30">
              <el-col class="my_top" :span="12" v-if="companyTypeId === 2">
                        <el-row class="new_dw">
                            <el-col :span="5">托运方</el-col>
                            <el-col :span="19">
                                <input @click="blur11" type="text" class="gy-input" v-model="carrierIdV1" @keyup.enter="onelist1click1">
                            </el-col>
                            <el-col class="new_dw2" :span="1"><i class="iconfont icon-search"  @click="onelist1click1"></i></el-col>
              ...
              <el-col class="my_top" :span="12" v-if="companyTypeId !== 2">
                  <el-row class="new_dw">
                      <el-col :span="5">承运商</el-col>
                      <el-col :span="19">
                          <input @click="blur22" type="text" class="gy-input" v-model="carrierIdV2" @keyup.enter="onelist1click2">
                      </el-col>
                      <el-col class="new_dw2" :span="1"> <i class="iconfont icon-search"  @click="onelist1click2"></i></el-col>
