                ...
                <div class="navMenu-user-desc">
                    ...
                    <el-dropdown trigger="click" @command="setCompanyMain">
                        <p>
                            ...
                            <i class="el-submenu__icon-arrow icon el-icon-arrow-left"></i>
                        </p>
            ...
            <el-row class="tac">
                <el-col :span="12" v-if="showList">
                    <el-menu
                      ...
                      @open="handleOpen"
                      @close="handleClose">
                        <el-submenu :index="index.toString()" v-for="(nav,index) in navData" :key="index"
                                    :myId="index.toString()">
                            <template slot="title">
                                <i :class="nav.icon"></i>
                                <span>{{nav.name}}</span>
                            </template>
                            <div v-for="(navSecond,indexSecond) in nav.resourceAccessList" :key="index.toString()+'-'+indexSecond"
                                 class="level-2">
