            ...
            <div class="gy-table">
                <el-table
                    ...
                    <el-table-column
                            ...
                            width="100">
                        <template slot-scope="scope">
                            <span>{{scope.row.buyDeliveryStatus | deliveryState}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                            label="采购交割日期"
                            width="240">
                        <template slot-scope="scope">
                            <span>{{scope.row.buyPlanDeliveryDate}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                            label="申请交割量(吨)"
                    ...
                    <el-table-column
                            ...
                            width="140">
                        <template slot-scope="scope">
                            <span v-if="scope.row.purchaseOrderId">{{scope.row.buyAlreadyDeliveryQuantity|numToQuantity}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                            label="采购合同编号"
                            width="160">
                        <template slot-scope="scope">
                            <span>{{scope.row.buyContractCode}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                            label="创建时间"
                            width="200">
                        <template slot-scope="scope">
                            <span>{{scope.row.buyUpdatedDate | date(1)}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                            fixed="right"
...
export default {
    ...
    methods: {
        // 跳转详情
        detail (item) {
            this.$router.push({name: 'deliveryDetail', query: {id: item.id, purchaseOrderId: item.purchaseOrderId, activeType: 2}});
        },
        getlist () {
