                        ...
                        <div class="searchDate">
                            ...
                            <div class="d">
                                <el-date-picker
                                  ...
                                  type="date"
                                  value-format="timestamp"
                                  @change="params.endBuyPlanDeliveryDate = $tools.convertDateEnd(params.endBuyPlanDeliveryDate)"
                                  placeholder="结束日期">
                                </el-date-picker>
                            </div>
                        </div>
                        ...
                        <div class="searchDate">
                            ...
                            <div class="d">
                                <el-date-picker
                                  ...
                                  type="date"
                                  value-format="timestamp"
                                  @change="params.endBuyActualDeliveryDate = $tools.convertDateEnd(params.endBuyActualDeliveryDate)"
                                  placeholder="结束日期">
                                </el-date-picker>
                            </div>
                        </div>
                        ...
                        <div class="searchDate">
                            ...
                            <div class="d">
                                <el-date-picker
                                  ...
                                  type="date"
                                  value-format="timestamp"
                                  @change="params.endSellPlanDeliveryDate = $tools.convertDateEnd(params.endSellPlanDeliveryDate)"
                                  placeholder="结束日期">
                                </el-date-picker>
                            </div>
                        </div>
                        ...
                        <div class="searchDate">
                            ...
                            <div class="d">
                                <el-date-picker
                                  ...
                                  type="date"
                                  value-format="timestamp"
                                  @change="params.endSellActualDeliveryDate = $tools.convertDateEnd(params.endSellActualDeliveryDate)"
                                  placeholder="结束日期">
                                </el-date-picker>
                            </div>
                        </div>
        ...
        <div class="table_padding">
            <div class="gy-table">
                <el-table
                    ...
                    <el-table-column
                            ...
                            width="140">
                        <template slot-scope="scope">
                            <span><span v-if="scope.row.contractType === 1">{{scope.row.buyDeliveryQuantity|numToQuantity}}</span><span v-else-if="scope.row.contractType !== 1 && scope.row.buyDeliveryQuantity">{{scope.row.buyDeliveryQuantity|numToQuantity}}</span>
                            </span>
                            ...
                            <el-popover
                                ...
                                <el-table :data="scope.row.buyDeliveryItemList">
                                    <el-table-column property="deliveryQuantity"  label="申请交割量(吨)" width="120">
                                        <template slot-scope='item'><div>{{item.row.deliveryQuantity | numToQuantity}}</div></template>
                                    </el-table-column>
                            ...
                            <!-- --------------------- -->
                            <span><span v-if="scope.row.contractType === 1">{{scope.row.sellDeliveryQuantity|numToQuantity}}</span><span v-else-if="scope.row.contractType !== 1 && scope.row.sellDeliveryQuantity">{{scope.row.sellDeliveryQuantity|numToQuantity}}</span>
                    ...
                    <el-table-column
                            ...
                            width="140">
                        <template slot-scope="scope">
                            <span v-if="scope.row.purchaseOrderId">{{scope.row.buyAlreadyDeliveryQuantity|numToQuantity}}</span><br>
                            <span v-if="scope.row.saleOrderId">{{scope.row.sellAlreadyDeliveryQuantity|numToQuantity}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                            v-bind:label="'采购合同编号\n销售合同编号'"
            ...
            <listStatistics @toggleTabs="getAllPageStatusCount">
                <div class="list-statistics-item">
                    <div class="list-statistics-item-l"><span>采购申请交割(吨)</span><span>{{getAllPageStatusCountObj.expectBuyDeliveryQuantityCount | numToQuantity}}</span></div>
                    <div class="list-statistics-item-l"><span>采购完成交割(吨)</span><span>{{getAllPageStatusCountObj.approvaledBuyDeliveryQuantityCount | numToQuantity}}</span></div>
                    <div class="list-statistics-item-l"><span>实时库存(吨)</span><span>{{getAllPageStatusCountObj.realtimeBuyDeliveryCount | numToQuantity}}</span></div>
                    <div class="list-statistics-item-l"><span>销售申请交割(吨)</span><span>{{getAllPageStatusCountObj.expectSellDeliveryQuantityCount | numToQuantity}}</span></div>
                    <div class="list-statistics-item-l"><span>销售完成交割(吨)</span><span>{{getAllPageStatusCountObj.approvaledSellDeliveryQuantityCount | numToQuantity}}</span></div>
                    <div class="list-statistics-item-l"><span>交叉交割(吨)</span><span>{{getAllPageStatusCountObj.crossSellDeliveryCount | numToQuantity}}</span></div>
                </div>
            </listStatistics>
        </div>
    <!-- 翻页 -->
