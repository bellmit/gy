            ...
            <table class="gy-table">
                ...
                <tbody v-if="tableData.length !== 0">
                    <tr v-for="(item, index) in tableData" :key="index">
                        ...
                        <td>{{item.salesQuantity?item.salesQuantity:'-'}}</td>
                        <td><span v-if="item.salesUnitPrice">{{item.salesUnitPrice | numToCash}}</span><span v-else>-</span></td>
                        <td><span v-if="item.contractAmount">{{item.contractAmount | numToCash}}</span><span v-else>-</span></td>
                        ...
                        <td><span v-if="item.realPrice">{{item.realPrice | numToCash}}</span><span v-else>-</span></td>
                        <td>{{item.realQuantity?item.realQuantity:'-'}}</td>
                        <td><span v-if="item.realContractPrice">{{item.realContractPrice | numToCash}}</span><span v-else>-</span></td>
                        <td>{{item.realDeliveryWarehouseName?item.realDeliveryWarehouseName:'-'}}</td>
                        <td>{{item.deliveriedQuantity?item.deliveriedQuantity:'-'}}</td>
                        <td>{{item.undeliveriedQuantity?item.undeliveriedQuantity:'-'}}</td>
                        <td><span v-if="item.receivedAmount">{{item.receivedAmount | numToCash}}</span><span v-else>-</span></td>
                        <td><span v-if="item.unreceivedAmount">{{item.unreceivedAmount | numToCash}}</span><span v-else>-</span></td>
