          ...
          <el-table-column
            ...
            <template slot-scope="scope">
                <template v-if="scope.row.purchaseOrderId">
                    ...
                    <span v-else>{{scope.row.shouldPaymentTotal | numToCash}}</span>
                </template>
            </template>
          </el-table-column>
          <el-table-column
            ...
            <template slot-scope="scope">
                <template v-if="scope.row.purchaseOrderId">
                    ...
                    <span v-else>{{scope.row.needPaymentTotal | numToCash}}</span>
                </template>
            </template>
          </el-table-column>
          <el-table-column
            ...
            width="150">
            <template slot-scope="scope">
              <span>{{scope.row.paymentDate | date}}</span>
            </template>
          </el-table-column>
          <el-table-column
            label="采购合同编号"
            width="140">
            <template slot-scope="scope">
              <span>{{scope.row.purchaseCcontractCode}}</span>
            </template>
          </el-table-column>
          <el-table-column
            label="创建时间"
            width="160">
            <template slot-scope="scope">
              <span>{{scope.row.paymentCreatedDate | date(1)}}</span>
            </template>
          </el-table-column>
          <el-table-column
            fixed="right"
