<template>
    <div class="deliveryDetails">
        <el-dialog width="1200px" class="order-dialog"
            ...
            <div class="block clearfix">
              ...
              <div class="gy-form-group">
                  ...
                  <span class="left-align">{{orderMessage.skuQuantity|numToQuantity}}</span>
              </div>
              ...
              <div class="gy-form-group">
                  ...
                  <span class="left-align">{{orderMessage.surplusQuantityTwos|numToQuantity}}</span>
              </div>
            </div>
            <!-- 进度条 -->
        ...
        <el-dialog width="1200px" class="order-dialog"
            ...
            <div class="gy-form-group">
                <span class="l spanLeft">换货仓库</span>
            ...
            <div class="gy-form-group cl">
                ...
                <span class="left-align">{{orderMessage.alreadyDeliveryQuantity|numToQuantity}}</span>
            </div>
            <div class="gy-form-group">
                <span class="l spanLeft">待交割数量(吨)</span>
                <span class="left-align">{{orderMessage.surplusQuantityTwos|numToQuantity}}</span>
            ...
            <table class="gy-table" style="width: 96%;">
                ...
                <tbody v-if="this.purchaseContractList.length > 0">
                    <tr v-for="(item, index) in purchaseContractList" :key="index">
                        ...
                        <td style="text-align: right">{{item.skuQuantity|numToQuantity}}</td>
                        <td style="text-align: right">{{item.alreadyStoreQuantity|numToQuantity}}</td>
                        <td style="text-align: right">{{(item.supAcrossRelQuantity)|numToQuantity}}</td>
