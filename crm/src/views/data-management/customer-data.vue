...
export default {
    ...
    methods: {
        ...
        statistic (e) {
            ...
            this.$http.get(this.$api.charts.statistics + '?statisticsId=1' + (this.userCompanyId ? '&userCompanyId=' + this.userCompanyId : ''))
                .then((res) => {
                    if (res.data.code === 0) {
        ...
        drawBrokenLine2 (type) {
            ...
            case 3:
                data = {
                    seriesData: [
                        {value: this.statistics.newAdded, name: '本月新增客户数', rich: 'b'},
                        {value: this.statistics.myNewAdded, name: '我的月新增客户数', rich: 'c'},
                        {value: this.statistics.total, name: '总客户数', rich: 'a'},
