            ...
            <table class="gy-table">
                ...
                <tr v-else v-for="(item, index) of manageList" :key="index">
                    ...
                    <td style="width: 170px;max-width: 170px">
                        <el-tooltip :disabled="(item.name && item.name.replace(/[^x00-xff]/g, 'aa').length > 17)? disabled : !disabled" placement="top" effect="light">
                            <div class="tootip" slot="content">{{item.name}}</div>
                            <div>{{item.name}}</div>
                        </el-tooltip>
                    </td>
                    <td style="width:400px;max-width: 400px">
                        <el-tooltip :disabled="(item.positionDesc && item.positionDesc.replace(/[^x00-xff]/g, 'aa').length > 63)? disabled : !disabled" placement="top" effect="light">
                    ...
                    <td style="width:450px;max-width: 450px">
                        <el-tooltip poper-class="test" :content="item.remark" :disabled="(item.remark && item.remark.replace(/[^x00-xff]/g, 'aa').length > 71)? disabled : !disabled" placement="top" effect="light">
