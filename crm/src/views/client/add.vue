  ...
  <div class="my-container">
      ...
      <div class="gy-form ">
            ...
            <div class="gy-form-group">
                ...
                <el-select   v-model="formData.customerStatus"  placeholder="请选择">
                    <el-option
     ...
     <div class="gy-form ">
        <p class="model_title"><i class="iconfont icon-xiangxixinxi"></i> 详细信息</p>
            ...
            <div class="gy-form-group">
                ...
                <input  @change="dataToFixed('registeredCapital', 2)" type="number" placeholder="请填写" class="gy-input three-column"  v-model.number="formData.registeredCapital">元
            </div>
            ...
            <div class="gy-form-group">
             ...
             <div class="gy-form-group">
                ...
                <input  type="text" placeholder="请填写" class="gy-input"  v-model="formData.products">
            </div>
             <div class="clearfix  gy-form-group">
                <span class="l"> 年产量</span>
                <input  type="number"   @change="dataToFixed('annualYield', 2)" placeholder="请填写" class="gy-input three-column"  v-model.number="formData.annualYield">吨
            </div>
            <div class="gy-form-group">
            ...
            <div class="gy-form-group">
                ...
                <input type="number" placeholder="请填写" class="gy-input three-column"   @change="dataToFixed('annualTurnover', 2)"  v-model.number="formData.annualTurnover">吨
            </div>
            <div class="gy-form-group">
                <span class="l"> 年营业额</span>
                <input type="number" placeholder="请填写" class="gy-input three-column"  @change="dataToFixed('annualAmount', 2)" v-model.number="formData.annualAmount">元
            </div>
            <div class="gy-form-group clearfix">
            ...
            <div class="contact-con">
                ...
                <div class="add-contact"><button   @click="addContact"  class="gy-button-normal">新增</button></div>
                <table  class="gy-table">
                    ...
                    <tr v-for="(item,index) in formData.customerContacts" :key="index">
                        ...
                        <td><button @click="editcontact(index)" class="gy-button-view">编辑</button><button @click="deleteContact(index)" class="gy-button-view add-margin">删除</button></td>
                    </tr>
                    </tbody>
                   <tbody v-else>
                        <tr>
            ...
            <div class="add-dialog gy-form" style="overflow: hidden">
                ...
                <div class="gy-form-group">
                 ...
                 <div class="submit-con" style="margin-right:30px;">
                    <div @click='saveContactData' class="gy-button-normal form_save">保存</div>
